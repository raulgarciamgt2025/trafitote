<?php
  ...
  include('../tools.php');
   ...
   $str_sql .= "    usuario_cambio_descripcion= '".$_SESSION['id_usuario']."', ";
   $str_sql .= "    razon_cambio_descripcion= '".$_REQUEST['motivo']."', ";
   $str_sql .= "    fecha_cambio_descripcion= GETDATE() ";
   ...
   if (!$resultado)
   {
    ...
    $str_sql .= "VALUES(7,GETDATE(),'".$_SESSION['id_usuario']."','".$_REQUEST['codigo_barra']."') ";
    $resultado = mssql_query($str_sql,$enlace);
    if (!$resultado)
    {
        echo  mssql_get_last_message();
