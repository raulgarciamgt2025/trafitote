<?php
// Standalone test version of panel_avances.php without authentication requirements
...
// Function to generate CSRF token for testing
function generateTestCSRFToken() {
    return 'test_csrf_token_' . time();
}
?>
...
<head>
    ...
    <title>Panel de Avances - Test AJAX</title>
            ...
            <div class="card shadow-sm">
                <div class="card-header text-white" style="background: linear-gradient(135deg, #3d4a2d 0%, #2a3d1e 100%); border-bottom: 2px solid #243a1a;">
                    <h5 class="mb-0">
                        ...
                        Panel de Avances - Estado de Paquetes (Test AJAX)
                    </h5>
                </div>
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-12 text-center">
                            <form id="frmRefresh" method="post" action="">
                                <input type="hidden" name="csrf_token" value="<?php echo generateTestCSRFToken(); ?>">
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="alert alert-info">
                                ...
                                <strong>Última actualización:</strong> <span id="lastUpdateTime"><?php echo date('d/m/Y H:i:s'); ?></span>
                            ...
                            <div class="card border-info">
                                ...
                                <div class="card-body">
                                    <ul class="mb-0">
                                        ...
                                        <li><strong>Test Mode:</strong> Esta versión usa datos de demostración para pruebas</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
console.log('[PanelAvances] Starting test version...');
...
function loadPanelData(showAlert = false) {
    ...
    $.ajax({
        ...
        error: function(xhr, status, error) {
            ...
            console.error('[PanelAvances] Response text:', xhr.responseText);
