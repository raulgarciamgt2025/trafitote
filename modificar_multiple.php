...
<!--
	...
	{
        if ( document.getElementById("txtmultiple").value == "" )
        {
            alert("Multiple en blanco");
            document.getElementById("txtmultiple").focus();
            return;
        }
		...
		$.post("db/modificar_multiple.php",
			   { codigo_barra: <?php echo $_REQUEST['codigo_barra'] ?>,
                 multipieza: document.getElementById("txtmultiple").value,
...
<table width="50%" border="0" align="center" class="adminform" id="tblFiltros" style="width:50%">
     <tr>
      <th colspan="2" class="msgconfig">MODIFICAR MULTIPIEZA</th>
     </tr>
     <tr>
    ...
    <tr>
     ...
     <tr>
     <td width="20%"><div align="left">Código Barra Multiple:</div></td>
     <td width="80%"><div align="left">
       <input name="txtmultiple" type="text" id="txtmultiple" value="" size="75" maxlength="200" />
     </div></td>
     </tr>
     <tr>
