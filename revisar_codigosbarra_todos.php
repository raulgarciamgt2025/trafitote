...
<!--
    ...
    function enlazar_documento()
	{
		...
		$.post("db/enlazar_documento__cargados.php",
...
<table width="50%" border="0" align="center" class="table table-sm" id="tblFiltros" style="width:50%">
     <tr>
      <th colspan="2" class="msgconfig">REVISION DE CODIGOS DE BARRA</th>
     </tr>
     <tr>     </tr>
     <tr>
...
<p>&nbsp;</p>
<p>CODIGOS ENCONTRADOS ENCONTRADAS:</p>
<div id="grid_codigos"></div>

<?php
   } catch (Exception $e) {
       error_log("Error in revisar_codigosbarra_todos.php: " . $e->getMessage());
...
$.post("http://www.transexpress.com.gt/codigos_barraV2.php",
			   { codigo_barra: '<?php echo $registro['codigo_barra'] ?>'
			   },
			   function (respuesta)
			   {
				   document.getElementById("grid_codigos").innerHTML = respuesta;
			   }
			  )
</script>